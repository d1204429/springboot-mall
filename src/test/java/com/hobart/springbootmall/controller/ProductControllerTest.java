...
public class ProductControllerTest {
    ...
    public void createProduct_success() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.productName", Matchers.equalTo("test food product")))
                .andExpect(jsonPath("$.category", Matchers.equalTo("FOOD")))
                .andExpect(jsonPath("$.imageUrl", Matchers.equalTo("http://test.com")))
                .andExpect(jsonPath("$.price", Matchers.equalTo(100)))
                .andExpect(jsonPath("$.stock", Matchers.equalTo(2)))
    ...
    public void getProducts() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.limit", Matchers.notNullValue()))
                .andExpect(jsonPath("$.offset", Matchers.notNullValue()))
                .andExpect(jsonPath("$.total", Matchers.notNullValue()))
    ...
    public void getProducts_sorting() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", Matchers.notNullValue()))
                .andExpect(jsonPath("$.results", hasSize(5)))
                .andExpect(jsonPath("$.results[0].productId", Matchers.equalTo(6)))
                .andExpect(jsonPath("$.results[1].productId", Matchers.equalTo(5)))
                .andExpect(jsonPath("$.results[2].productId", Matchers.equalTo(7)))
                .andExpect(jsonPath("$.results[3].productId", Matchers.equalTo(4)))
                .andExpect(jsonPath("$.results[4].productId", Matchers.equalTo(2)));
    }
    ...
    public void getProducts_pagination() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", Matchers.notNullValue()))
                .andExpect(jsonPath("$.results", hasSize(2)))
                .andExpect(jsonPath("$.results[0].productId", Matchers.equalTo(5)))
                .andExpect(jsonPath("$.results[1].productId", Matchers.equalTo(4)));
    }
